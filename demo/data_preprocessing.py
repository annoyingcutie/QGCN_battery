...
class Feature_Selector_Dataset(Dataset):
    def __init__(self, train=True, pred_target='quality', part='discharge', norm=True):
        """
        train(bool): training or testing set
        pred_target(str): 'EOL' or 'chargetime' or 'quality'
    ...
    def __getitem__(self, index):
        if self.pred_target=='EOL':
            target_id = 0 
        elif self.pred_target=='chargetime':
            target_id = 1
        else:
            target_id = 2
